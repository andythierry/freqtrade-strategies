...
class E0V1E20231004085308(IStrategy):
    minimal_roi = {
        "0": 0.02,
        "120": 0.01
    }
    ...
    def populate_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        # 🛠 Correction : Cast vers float pour éviter erreurs Pandas (LossySetitemError)
        for col in ['sma_15', 'cti', 'rsi', 'rsi_fast', 'rsi_slow', 'fastk']:
